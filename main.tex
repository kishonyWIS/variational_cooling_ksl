...
\item $U_{\kappa}(\delta_\ell) = \exp\left(-i (\delta_\ell/2) \sum_{\langle\langle \mathbf{J},\mathbf{K},\mathbf{L}\rangle\rangle}\sigma_{\mathbf{J}}^x\tau_{\mathbf{J}}^z\sigma_{\mathbf{K}}^y\tau_{\mathbf{K}}^z\sigma_{\mathbf{L}}^z\right)$ for the three-spin $\kappa$ term
